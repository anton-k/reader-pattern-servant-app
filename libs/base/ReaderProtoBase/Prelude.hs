module ReaderProtoBase.Prelude
  ( module Exports,
    showAsText,
  )
where
...
import Data.Time.Format.ISO8601 as Exports (iso8601Show)
...
import Prelude as Exports hiding (all, and, any, concat, concatMap, elem, fail, find, foldl, foldl1, foldr, foldr1, id, lookup, mapM, mapM_, maximum, minimum, notElem, or, product, sequence, sequence_, sum, (.))

showAsText :: Show a => a -> Text
showAsText = fromList . show
